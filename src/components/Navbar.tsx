            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              {isAuthenticated ? (
                <div ref={userMenuRef} className="relative">
                  ...
                  {userMenuOpen && (
                    <div className="absolute right-0 mt-3 w-72 bg-[#141414]/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white/10 py-2 z-50 transform origin-top-right transition-all duration-200 animate-scale-in">
                      {/* User Info */}
