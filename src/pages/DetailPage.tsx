...
import { Movie, TVShow, Video, MovieCredits, CastMember, CrewMember, PersonDetails, PersonMovieCredits } from '../types';
...
const DetailPage: React.FC<DetailPageProps> = ({ type }) => {
  ...
  const getCrewByDepartment = () => {
    ...
    const sortedDepartments: { [key: string]: CrewMember[] } = {};
    const departmentOrder = ['Directing', 'Writing', 'Production', 'Camera', 'Sound', 'Editing', 'Art', 'Costume & Make-Up', 'Visual Effects'];
    
    departmentOrder.forEach(dept => {
      if (departments[dept]) {
        sortedDepartments[dept] = departments[dept].slice(0, 4); // Limit to 4 per department
      }
    });
    ...
    <div className="min-h-screen bg-netflix-black text-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="absolute top-24 left-8 z-20">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 bg-black/70 backdrop-blur-md px-6 py-3 rounded-full hover:bg-black/90 transition-all duration-300 border border-white/20 hover:border-white/40 shadow-xl"
          >
        ...
        <div className="relative z-10 h-full flex items-end pb-16">
          <div className="max-w-7xl mx-auto px-16 grid grid-cols-1 lg:grid-cols-4 gap-12 items-end">
            {/* Movie Poster */}
            ...
            <div className="lg:col-span-3 space-y-6 lg:pl-8">
              ...
              <div>
                ...
                <div className="mb-6">
                  <p className="text-lg text-gray-200 leading-relaxed line-clamp-2 max-w-4xl">
                    {content.overview}
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-6 text-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-400">({content.vote_count?.toLocaleString()} votes)</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-400 mr-2">{type === 'movie' ? 'Director:' : 'Creator:'}</span>
              ...
              <div className="flex flex-wrap gap-4">
                <button 
                  ...
                  className="flex items-center gap-3 bg-netflix-red hover:bg-netflix-red/80 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-xl hover:scale-105"
                >
      ...
      {showVideoModal && selectedVideo && (
        ...
        >
          <div 
            className="relative w-full max-w-4xl bg-netflix-black rounded-lg overflow-hidden shadow-2xl"
              ...
              {personFilmography && personFilmography.cast.length > 0 ? (
                ...
                <div className="flex items-center justify-center py-12">
                  <div className="text-center">
                    ...
                    <p className="text-gray-400">Loading filmography...</p>
                  </div>
                </div>
              ) : (
                <div className="text-center py-12">
